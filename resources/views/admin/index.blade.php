...
@section('page', 'Administrative panel')
              ...
              <div class="panel  panel-widget border-right">
                <div class="row no-padding">
                	<i class="fas fa-eye"></i>
                  		...
                  		<div class="dashboard-small">Visitor</div>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-3 col-lg-3 no-padding">
              <div class="panel panel-widget border-right">
                <div class="row no-padding">
                	<em class="fas fa-file-upload"></em>
                  		...
                  		<div class="dashboard-small">Files</div>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-3 col-lg-3 no-padding">
              <div class="panel  panel-widget border-right">
                <div class="row no-padding">
                	<em class="fa fa-xl fa-users color-teal"></em>
                  		...
                  		<div class="dashboard-small">Users</div>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-3 col-lg-3 no-padding">
              <div class="panel  panel-widget ">
                <div class="row no-padding">
                	<em class="fa fa-xl fa-search color-red"></em>
                  		...
                  		<div class="dashboard-small">Visited pages</div>
                </div>
              </div>
            </div>
          </div><!--/.row-->
...
@section('scripts')
    ...
    <!-- Library Chart CDN to show charts  -->
