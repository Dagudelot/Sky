...
<div class="container">
	<form class="was-validated" action="{{ route('roles.store') }}" method="POST">
		@csrf
		...
		<div class="form-row">
			<div class="col-sm-6 mb-3">
				...
				<input type="text" name="name" class="form-control is-valid" id="RoleName" placeholder="Role name" required>
		...
		<button class="btn btn-primary">Add role <i class="fas fa-plus-circle pull-right"></i></button>
	</form>
</div>
